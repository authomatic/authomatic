...
(function() {
  var $, Authomatic, BaseProvider, Foursquare, Google, LinkedIn, Oauth1Provider, Oauth2Provider, addJsonpCallback, deserializeCredentials, format, getProviderClass, globalOptions, jsonPCallbackCounter, log, parseQueryString, parseUrl, _ref, _ref1, _ref2, _ref3,
    __slice = [].slice,
    _this = this,
  ...
  Oauth2Provider = (function(_super) {
    ...
    function Oauth2Provider() {
      ...
      if (this.tokenType === '1') {
        ...
        this.params[this._x_accessToken] = this.accessToken;
      }
    }
