...
(function() {
  var $, Authomatic, BaseProvider, Foursquare, Google, LinkedIn, Oauth1Provider, Oauth2Provider, WindowsLive, addJsonpCallback, deserializeCredentials, format, getProviderClass, globalOptions, jsonPCallbackCounter, log, parseQueryString, parseUrl, _ref, _ref1, _ref2, _ref3, _ref4,
    __slice = [].slice,
    _this = this,
  ...
  Oauth2Provider = (function(_super) {
    ...
    function Oauth2Provider() {
      ...
      _ref1 = this.credentialsRest, this.accessToken = _ref1[0], this.refreshToken = _ref1[1], this.expirationTime = _ref1[2], this.tokenType = _ref1[3];
  ...
  Foursquare = (function(_super) {
    ...
    function Foursquare() {
      _ref1 = Foursquare.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  Google = (function(_super) {
    ...
    function Google() {
      _ref2 = Google.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  LinkedIn = (function(_super) {
    ...
    function LinkedIn() {
      _ref3 = LinkedIn.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  WindowsLive = (function(_super) {
    ...
    function WindowsLive() {
      this.handleTokenType = __bind(this.handleTokenType, this);      _ref4 = WindowsLive.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
