...
(function() {
  var $, Authomatic, BaseProvider, Flickr, Foursquare, Google, LinkedIn, Oauth1Provider, Oauth2Provider, WindowsLive, deserializeCredentials, format, getProviderClass, globalOptions, iOSChromeFix, jsonPCallbackCounter, log, openWindow, parseQueryString, parseUrl,
    __slice = [].slice,
  ...
  iOSChromeFix = function() {
    var isIOS, isIOSChrome, loginResultKey, vendorName, waitForLogin;
    isIOS = /iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase());
    vendorName = window.navigator.vendor;
    isIOSChrome = isIOS && vendorName === "Google Inc.";
    loginResultKey = 'authomaticloginresult';
    if (isIOSChrome && localStorage) {
      localStorage.removeItem(loginResultKey);
      waitForLogin = function() {
        var loginresult;
        loginresult = localStorage.getItem(loginResultKey);
        if (loginresult != null) {
          authomatic.loginComplete(JSON.parse(loginresult), function() {});
          return localStorage.removeItem(loginResultKey);
        } else {
          return setTimeout(waitForLogin, 300);
        }
      };
      return waitForLogin();
    }
  ...
  Foursquare = (function(_super) {
    ...
    function Foursquare() {
      return Foursquare.__super__.constructor.apply(this, arguments);
    }
  ...
  WindowsLive = (function(_super) {
    ...
    function WindowsLive() {
      this.handleTokenType = __bind(this.handleTokenType, this);
      return WindowsLive.__super__.constructor.apply(this, arguments);
    }
