...
OAUTH1 = {
    "bitbucket": {
        ...
        "_apis": {
            ...
            "Get your privileges": (
                "GET",
                "https://api.bitbucket.org/1.0/user/privileges",
            ),
        },
    },
    "flickr": {
        ...
        "_apis": {
            "List your photos": (
                "GET",
                "http://api.flickr.com/services/rest?method=flickr.activity.userPhotos&format=json",
            ),
            "List your comments": (
                "GET",
                "http://api.flickr.com/services/rest?method=flickr.activity.userComments&format=json",
            ),
        },
    },
    "meetup": {
    ...
    "plurk": {
        ...
        "_apis": {
            "Get your plurks": (
                "GET",
                "http://www.plurk.com/APP/Timeline/getPlurks?filter=only_user",
            ),
            "Plurk something": (
                "POST",
                "http://www.plurk.com/APP/Timeline/plurkAdd?qualifier=says&content={message}",
            ),
        },
    },
    "twitter": {
    ...
    "tumblr": {
        ...
        "_apis": {
            ...
            "Follow": (
                "POST",
                "https://api.tumblr.com/v2/user/follow?url={message}",
                "Tumblr blog URL",
                "peterhudec.tumblr.com",
            ),
        },
    },
    "vimeo": {
        ...
        "_apis": {
            "Get your activity": (
                "GET",
                "http://vimeo.com/api/rest/v2?method=vimeo.activity.happenedToUser&format=json&user_id={user.id}",
            ),
        },
    },
    "xero": {
    ...
    "xing": {
        ...
        "_apis": {
            "Get job recommendations": (
                "GET",
                "https://api.xing.com/v1/users/{user.id}/jobs/recommendations",
            ),
            "Get activity stream": (
                "GET",
                "https://api.xing.com/v1/users/{user.id}/feed",
            ),
        },
    },
    "yahoo": {
        ...
        "_apis": {
            "Get recent emails": (
                "GET",
                "http://query.yahooapis.com/v1/yql?q=select%20*%20from%20ymail.messages%20where%20numMid%3D'5'&format=json&securityLevel=user",
            ),
        },
    },
}
...
OAUTH2 = {
    ...
    "bitly": {
        ...
        "_apis": {
            "Get your link history": (
                "GET",
                "https://api-ssl.bitly.com/v3/user/link_history",
            ),
            "Shorten a URL": (
                "GET",
                "https://api-ssl.bitly.com/v3/shorten?longUrl={message}",
                "URL",
                "http://peterhudec.com",
            ),
        },
    ...
    "eventbrite": {
        ...
        "_apis": {
            "List your orders": (
                "GET",
                "https://www.eventbriteapi.com/v3/users/{user.id}/orders/",
            ),
            "List your owned events": (
                "GET",
                "https://www.eventbriteapi.com/v3/users/{user.id}/owned_events/",
            ),
            "Search for event": (
                "GET",
                "https://www.eventbriteapi.com/v3/events/search/?q={message}",
                "search string",
                "Little Britain",
            ),
        },
    ...
    "facebook": {
        ...
        "_apis": {
            "Get your recent statuses": (
                "GET",
                "https://graph.facebook.com/{user.id}/feed",
            ),
            "Share this page": (
                "POST",
                "https://graph.facebook.com/{user.id}/feed?message={message}&link=http://authomatic-example.appspot.com",
                "Enter comment",
                "This app is ...",
            ),
        },
    ...
    "foursquare": {
        ...
        "_apis": {
            "Get your recent checkins": (
                "GET",
                "https://api.foursquare.com/v2/users/{user.id}/checkins",
            ),
            "Get your badges": (
                "GET",
                "https://api.foursquare.com/v2/users/{user.id}/badges",
            ),
        },
    },
    "github": {
    ...
    "vk": {
        ...
        "_apis": {
            "Get your history": (
                "GET",
                "https://api.vk.com/method/activity.getHistory",
            ),
