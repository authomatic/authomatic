...
CONFIG = {
    ...
    "user": {
        ...
        "picture": re.compile(
            r"^https://\w+\.assets-yammer\.com/mugshot/" r"images/48x48/[\w-]+$"
        ),
        "postal_code": None,
    ...
    "content_should_contain": [
        ...
        "contact",
        "department",
        "dismissed_apps_tooltip",
        "dismissed_browser_lifecycle_banner",
        "dismissed_feed_tooltip",
        "dismissed_group_tooltip",
        "dismissed_invite_tooltip",
        "dismissed_invite_tooltip_at",
        "dismissed_profile_prompt",
        "email",
        "email_addresses",
        "enable_chat",
        "enable_groups",
        "enable_private_messages",
        "enter_does_not_submit_message",
        "expertise",
        "external_urls",
        "first_name",
    ...
    # Case insensitive
    "content_should_not_contain": conf.no_gender
    + conf.no_nickname
    + conf.no_postal_code,
