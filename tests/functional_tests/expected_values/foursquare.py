...
CONFIG = {
    ...
    'content_should_contain': [
        ...
        'contact', 'email', 'facebook', 'phone', 'twitter', 'superuser',
        'default', 'checkinPings', 'pings', 'badges', 'badgeId',
        ...
        'source', 'url', 'mayorships', 'venue', 'formattedPhone', 'address',
        'postalCode', 'cc', 'city', 'country', 'categories', 'pluralName',
        'shortName', 'icon', 'primary', 'verified', 'stats', 'checkinsCount',
        'usersCount', 'tipCount', 'likes', 'summary', 'like', 'beenHere',
        'marked', 'width', 'height', 'visibility', 'following', 'requests',
        'editable', 'public', 'collaborative', 'canonicalUrl', 'followers',
        'listItems', 'checkin', 'scores', 'recent', 'max', 'goal', 'referralId'
    ],
    # Case insensitive
