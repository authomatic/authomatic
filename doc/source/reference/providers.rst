...
**provider**, **consumer**, **user** triangle.
There is no reason for you to instatniate them manualy.
You only should specify them in the :doc:`config`.

Some provider types accept additional keyword arguments in their constructor
passed to them via the :doc:`config` or the :func:`authomatic.login` keyword arguments.
